...
from descartes import \
    PolygonPatch  # To plot polygons as patches (https://bitbucket.org/sgillies/descartes/src): pip install descartes
...
def segment_cells_nuclei(image_input, image_output, h_threshold=15, min_size_cell=200, min_size_nuclei=1000,
                         save_path=None):
